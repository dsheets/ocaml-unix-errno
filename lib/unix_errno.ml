...
external e2big           : unit -> int = "unix_errno_e2big"
external eacces          : unit -> int = "unix_errno_eacces"
external eagain          : unit -> int = "unix_errno_eagain"
external ebadf           : unit -> int = "unix_errno_ebadf"
external ebusy           : unit -> int = "unix_errno_ebusy"
external echild          : unit -> int = "unix_errno_echild"
external edeadlk         : unit -> int = "unix_errno_edeadlk"
external edom            : unit -> int = "unix_errno_edom"
external eexist          : unit -> int = "unix_errno_eexist"
external efault          : unit -> int = "unix_errno_efault"
external efbig           : unit -> int = "unix_errno_efbig"
external eintr           : unit -> int = "unix_errno_eintr"
external einval          : unit -> int = "unix_errno_einval"
external eio             : unit -> int = "unix_errno_eio"
external eisdir          : unit -> int = "unix_errno_eisdir"
external emfile          : unit -> int = "unix_errno_emfile"
external emlink          : unit -> int = "unix_errno_emlink"
external enametoolong    : unit -> int = "unix_errno_enametoolong"
external enfile          : unit -> int = "unix_errno_enfile"
external enodev          : unit -> int = "unix_errno_enodev"
external enoent          : unit -> int = "unix_errno_enoent"
external enoexec         : unit -> int = "unix_errno_enoexec"
external enolck          : unit -> int = "unix_errno_enolck"
external enomem          : unit -> int = "unix_errno_enomem"
external enospc          : unit -> int = "unix_errno_enospc"
external enosys          : unit -> int = "unix_errno_enosys"
external enotdir         : unit -> int = "unix_errno_enotdir"
external enotempty       : unit -> int = "unix_errno_enotempty"
external enotty          : unit -> int = "unix_errno_enotty"
external enxio           : unit -> int = "unix_errno_enxio"
external eperm           : unit -> int = "unix_errno_eperm"
external epipe           : unit -> int = "unix_errno_epipe"
external erange          : unit -> int = "unix_errno_erange"
external erofs           : unit -> int = "unix_errno_erofs"
external espipe          : unit -> int = "unix_errno_espipe"
external esrch           : unit -> int = "unix_errno_esrch"
external exdev           : unit -> int = "unix_errno_exdev"
external ewouldblock     : unit -> int = "unix_errno_ewouldblock"
external einprogress     : unit -> int = "unix_errno_einprogress"
external ealready        : unit -> int = "unix_errno_ealready"
external enotsock        : unit -> int = "unix_errno_enotsock"
external edestaddrreq    : unit -> int = "unix_errno_edestaddrreq"
external emsgsize        : unit -> int = "unix_errno_emsgsize"
external eprototype      : unit -> int = "unix_errno_eprototype"
external enoprotoopt     : unit -> int = "unix_errno_enoprotoopt"
external eprotonosupport : unit -> int = "unix_errno_eprotonosupport"
external esocktnosupport : unit -> int = "unix_errno_esocktnosupport"
external eopnotsupp      : unit -> int = "unix_errno_eopnotsupp"
external epfnosupport    : unit -> int = "unix_errno_epfnosupport"
external eafnosupport    : unit -> int = "unix_errno_eafnosupport"
external eaddrinuse      : unit -> int = "unix_errno_eaddrinuse"
external eaddrnotavail   : unit -> int = "unix_errno_eaddrnotavail"
external enetdown        : unit -> int = "unix_errno_enetdown"
external enetunreach     : unit -> int = "unix_errno_enetunreach"
external enetreset       : unit -> int = "unix_errno_enetreset"
external econnaborted    : unit -> int = "unix_errno_econnaborted"
external econnreset      : unit -> int = "unix_errno_econnreset"
external enobufs         : unit -> int = "unix_errno_enobufs"
external eisconn         : unit -> int = "unix_errno_eisconn"
external enotconn        : unit -> int = "unix_errno_enotconn"
external eshutdown       : unit -> int = "unix_errno_eshutdown"
external etoomanyrefs    : unit -> int = "unix_errno_etoomanyrefs"
external etimedout       : unit -> int = "unix_errno_etimedout"
external econnrefused    : unit -> int = "unix_errno_econnrefused"
external ehostdown       : unit -> int = "unix_errno_ehostdown"
external ehostunreach    : unit -> int = "unix_errno_ehostunreach"
external eloop           : unit -> int = "unix_errno_eloop"
external eoverflow       : unit -> int = "unix_errno_eoverflow"
